...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mMMS_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mMMS_CP.txt' % (H, P, str(len(cp))))
...
def sarfraz():
    ...
    if _sarfraz___ in ('3', 'ee'):
         ...
         os.system("xdg-open https://https://www.facebook.com/musa.khan.39545")
